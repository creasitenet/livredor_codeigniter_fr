	...
	<nav class="navbar navbar-default">
		...
		<div class="container-fluid">
        	...
        	<div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url(); ?>">Livre D'or - Codeigniter 3</a>
				...
				<ul class="nav navbar-nav">
                   ...
                   -->
                    <li><a href="https://github.com/creasitenet/livredor_codeigniter_fr" target="_blank">Code sur Github</a></li>
                   	...
                   	<!--
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Autres versions <span class="caret"></span></a>
                        <ul class="dropdown-menu" role="menu">
                          <li><a href="#">CakePHP</a></li>
                          <li><a href="#">FuelPHP</a></li>
